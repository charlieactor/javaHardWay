public class HeronsFormula {
	public static void main( String[] args ) {
		...
		System.out.println(tws + "9, 9, 9 has area" + b);
	...
	// This function computes the area of a triangle with side lengths a, b, and c
...
//it is shorter to use functions of course!
